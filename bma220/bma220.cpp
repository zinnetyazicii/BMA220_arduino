...
void BMA220::FallDetection(){
    ...
    Quanterion result1, result2;
    result1.q0=Q[0][0]; result1.q1=Q[1][0]; result1.q2=Q[2][0]; result1.q3=Q[3][0]; 
    result2.q0=Q[3][3]; result2.q1=-1*Q[2][3]; result2.q2=Q[1][3]; result2.q3=-1*Q[0][3]; 
